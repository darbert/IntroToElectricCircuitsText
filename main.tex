...
\input{ch_eqCircuits/intro}
\section{Resistors in Series}
\input{ch_eqCircuits/series}
\section{Resistors in Parallel}
\input{ch_eqCircuits/parallel}
...
%\input{ch_eqCircuits/complicated}
...
\input{ch_voltageDividers/maxPower}
...
\input{ch_opAmps/opAmp}
\section{Golden Rules}
\input{ch_opAmps/goldenRules}
...
% --------------------------------------------------------------------
\chapter{AC Circuits}
\input{ch_ACCircuits/alternatingCurrent}
\section{Phasor Notation}
\input{ch_ACCircuits/phasors}
\section{Capacitors}
\input{ch_ACCircuits/capacitors}
\section{Inductors}
\input{ch_ACCircuits/inductors}
\section{Equivalent Impedance and Ohm's Law}
\input{ch_ACCircuits/impedance}
% --------------------------------------------------------------------
\chapter{AC Power}
\section{Watt's Law for AC}
\input{ch_ACPower/ACwatt}
\section{Average Power}
\input{ch_ACPower/averagePower}
\section{Complex Power}
\input{ch_ACPower/complexPower}
...
\input{ch_passiveFilters/frequencyResponse}
\section{Two-element Filters}
\input{ch_passiveFilters/firstOrder}
\section{Second Order Filters}
\input{ch_passiveFilters/secondOrder}

% --------------------------------------------------------------------
\chapter{Active Filters}
\section{Op-Amps in AC}
\input{ch_activeFilters/ompAmpsAC}
\section{First Order Filters}
\input{ch_activeFilters/firstOrder}
\section{Second Order Filters}
\input{ch_activeFilters/secondOrder}
...
\input{ch_prelim/algebra}

\chapter{Units} \label{sec:PrelimUnits}
\input{ch_prelim/units}
\chapter{A Word on Graphs}
\input{ch_prelim/graph_theory}

\chapter{What is a Circuit?}
\input{ch_prelim/circuit.tex}

\chapter{Vector Mathematics}
\input{ch_prelim/vector_math}

\chapter{Complex Numbers}
\input{ch_prelim/complex_numbers}

\chapter{Linear Algebra}
\input{ch_prelim/linear_algebra}
